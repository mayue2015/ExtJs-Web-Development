...
//	10总投资收益率	五年利税前利润/合同期/静态投资
	...
	var res = Ext.decode(util.sendRequest('pmv/reactivePowerOptimizationController/calculateRoi.do',{
		assSvcId : assSvcId,
...
<body>
	...
	<tr><td colspan="3"></td></tr>
	<tr><td>分享比例：<input id="assShrRatioId" type="text" value='<%=assShrRatio %>' style="width:100;" nkeyup="checkNum(this)"/></td>
	...
	<tr><td colspan="3"></td></tr>
	<tr><td><font color="#FF0000">静态投资：<input id="costStaticId" type="text" value='<%=costStatic %>' style="width:100;border:1px solid red;" readonly="true" disabled="true"/>万元</font></td>
		<td>　动态投资：<input  id="costDynamicId" type="text" value='<%=costDynamic %>' style="width:100;" nkeyup="checkNum(this)"/>万元</td>
		<td>　　　<font color="#FF0000">年节电量：<input id="ySaveKwhId"type="text" value='<%=ySaveKwh %>' style="width:100;border:1px solid red;" readonly="true" disabled="true"/>万kWh</font></td></tr>
	<tr><td colspan="3"></td></tr>
	...
	<tr>
		<table width="100%"; table border="0" cellspacing="0" style="border-collapse:collapse">
		    <td style="border:1px solid red; width: 130px;height: 30px";";><font color=red>总投资收益率（%）：</font></td>
			<td style="width: 160px;border:1px solid red;"><input id="assCstInrateId" type="text" value='<%=assCstInrate %>' style="border:0px;width:160px;height: 30px;text-align:center;" disabled="true"/></td>
			<td >
				<input type="button" style="border:1px solid red;width: 70px;height: 30px;font-size:14px;margin-left:10px;" onclick="calculate()" value="计 算" />
			</td>
			<td>
				<div id="div5" style="text-align:center;font-size:12px;width:40px;height:22px;float:left;border:1px solid red;margin-left:5px;" onclick = "changeDiv(5,'div5')">5年</div>
				<div id="div6" style="text-align:center;font-size:12px;width:40px;height:22px;float:left;border:1px solid red;margin-left:5px;" onclick = "changeDiv(6,'div6')">6年</div>
				<div id="div7" style="text-align:center;font-size:12px;width:40px;height:22px;float:left;border:1px solid red;margin-left:5px;" onclick = "changeDiv(7,'div7')">7年</div>
				<div id="div8" style="text-align:center;font-size:12px;width:40px;height:22px;float:left;border:1px solid red;margin-left:5px;" onclick = "changeDiv(8,'div8')">8年</div>
		    </td>
		</table>
	</tr>
	</table>
